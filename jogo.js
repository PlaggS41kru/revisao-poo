class Personagem {
    constructor (nome, classe, forca, inteligencia, destreza) {
        ...
        if(forca + inteligencia + destreza > 10){
            throw new Error("A destribuição de pontos é no máximo 10.")
        }

        //Verificar se as classes escolhidas estão nas regras do jogo.
...
const p1 = new Personagem("Griffeld", "Guerreiro", 4 , 2, 4,)
const p2 = new Personagem("JG", "Arqueiro", 5, 3, 2 )
